...
df_24 = pd.read_csv('~/github/AZMP-NL/external_data/DMI/nuuk-2024.csv', delimiter=",")
df_25 = pd.read_csv('~/github/AZMP-NL/external_data/DMI/nuuk-2025.csv', delimiter=",")

df_all = pd.concat([df_14.Middel, df_15.Middel, df_16.Middel, df_17.Middel, df_18.Middel, df_19.Middel, df_20.Middel, df_21.Middel, df_22.Middel, df_23.Middel, df_24.Middel, df_25.Middel], axis=1, keys=np.arange(2014, 2025+1))
