...
for div in div_toplot:
    ...
    m.plot(div_lon, div_lat, 'slategray', linewidth=2, zorder=10)
    if (div == '3M') | (div == '4X'):
        ax.text(np.mean(div_lon), np.mean(div_lat), div, fontsize=12, color='slategray', fontweight='bold', zorder=100, verticalalignment='top', horizontalalignment='right')    
    elif (div == '3N'):
        ax.text(np.mean(div_lon)-100000, np.mean(div_lat)+280000, div, fontsize=12, color='slategray', fontweight='bold', zorder=100, verticalalignment='top', horizontalalignment='center')
    elif (div == '2J') | (div == '3K'):
        ax.text(np.mean(div_lon)-250000, np.mean(div_lat), div, fontsize=12, color='slategray', fontweight='bold', zorder=100, verticalalignment='top', horizontalalignment='left')
    elif (div == '3Ps'):
        ax.text(np.mean(div_lon), np.mean(div_lat), div, fontsize=12, color='slategray', fontweight='bold', zorder=100, verticalalignment='bottom', horizontalalignment='right')
    else:
        ax.text(np.mean(div_lon), np.mean(div_lat), div, fontsize=12, color='slategray', fontweight='bold', zorder=100)    
