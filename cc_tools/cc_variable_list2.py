...
def variable_parameters(my_variable):
    ...
    if my_variable == 'pH_Total_(total_scale)':
        return [9, 7.4, 8.2, 7.7, cmo.thermal_r, [7.2, 7.4, 7.5, 7.6, 7.7, 7.8, 7.9, 8.0, 8.1, 8.2], r'$\rm pH_{T,is}$', 'both', -.5, .5, 11]
...
#        return [21, 27, 37, 32, cmo.haline, [27, 29, 31, 33, 35, 37], r'Salinity', 'both']
        ...
        return [11, 0, 100, 40, cmo.oxy, [0,20,40,60,80,100], r'$\rm O_{2,sat}$ (%)', 'both', -10, 10, 11]
