'''
This script generates the map used for STACFEN presentation in 2024
It includes all NAFO subareas from 0-6
...
# Add NAFO divisions
div_toplot = ['0B', '1C', '1D', '1E', '1F', '2G', '2H', '2J', '3K', '3L', '3N', '3M', '3O', '3Ps', '4Vn', '4Vs', '4W', '4X', '5Y', '5Ze', '5Zw', '6A']
for div in div_toplot:
    ...
    elif (div == '3Ps') | (div == '0B') | (div == '6A') | (div == '5Y'):
