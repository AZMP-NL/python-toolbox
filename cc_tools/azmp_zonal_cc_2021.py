...
df = pd.read_csv('/home/cyrf0006/github/AZMP-NL/datasets/carbonates/AZMP_carbon_data_with2021.csv', delimiter=',')
...
# Save figure
fig.savefig('AZMP_OA_'+str(YEAR)+'_'+SEASON+'_'+FIG_VAR+'_'+DEPTH+'.png', format='png', dpi=300, bbox_inches='tight')
#lt.close('all') 
