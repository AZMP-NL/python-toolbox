...
variables = ['TripID', 'Region', 'StationID', 'timestamp', 'latitude', 'longitude', 'depth', 'NO3', 'O2', 'O2sat_perc', 'TA', 'temp_pH', 'pH_25', 'PO4', 'salinity', 'SiO', 'temperature', 'TIC', 'TAflag', 'pHflag', 'TICflag', 'Sample ID']
...
df = df[[
    ...
    'pH_25', 'temp_pH', 'TA', 'TIC', 'Sample ID']]
...
# Save NL data
df_NL.to_csv(os.path.join(dataset_main_path, 'AZMP-NL_carbon_data_ID.csv'), float_format='%.4f', index=True)
