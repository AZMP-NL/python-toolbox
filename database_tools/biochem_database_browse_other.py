...
df_BB_nut.to_pickle('BB_nutrients')
...
df_NO3clim = df_BB.groupby(['depth', 'sname'])['NO3'].mean()
df_PO4clim = df_BB.groupby(['depth', 'sname'])['PO4'].mean()
df_SIOclim = df_BB.groupby(['depth', 'sname'])['SIO'].mean()
...
df_season_surf = df_BB_O2_surf.resample('4M').mean()
df_season_btm = df_BB_O2_btm.resample('4M').mean()
#df_season_surf = df_BB_O2_surf.resample('A').mean()
#df_season_btm = df_BB_O2_btm.resample('A').mean()
...
#df_season_surf = df_BB_nut_surf.resample('A').mean()
#df_season_btm = df_BB_nut_btm.resample('A').mean()
...
plt.grid('on')
fig.set_size_inches(w=10,h=6)
fig_name = 'BB_NO3_timeseries.png'
fig.set_dpi(300)
fig.savefig(fig_name)
...
plt.grid('on')
fig.set_size_inches(w=10,h=6)
fig_name = 'BB_PO4_timeseries.png'
fig.set_dpi(300)
fig.savefig(fig_name)
...
plt.grid('on')
fig.set_size_inches(w=10,h=6)
fig_name = 'BB_SIO_timeseries.png'
fig.set_dpi(300)
fig.savefig(fig_name)
...
plt.grid('on')
fig.set_size_inches(w=10,h=6)
fig_name = 'BB_NO3onPO4_timeseries.png'
fig.set_dpi(300)
fig.savefig(fig_name)
...
plt.grid('on')
fig.set_size_inches(w=10,h=6)
fig_name = 'BB_NO3onSiO4_timeseries.png'
fig.set_dpi(300)
fig.savefig(fig_name)
...
plt.plot([1, 225, 225, 1, 1], [200,200,350,350,200], '--k')
fig.set_size_inches(w=9,h=6)
fig_name = 'BB_NO3onPO4.png'
fig.set_dpi(300)
fig.savefig(fig_name)



## All values timeseries
R1 = df['PO4']/df['NO3']
R1 = R1.replace([np.inf, -np.inf], np.nan)
R1 = R1.resample('A').mean()   
R2 = df['SIO']/df['NO3']
R2 = R2.replace([np.inf, -np.inf], np.nan)
R2 = R2.resample('A').mean()   

fig = plt.figure(1)
fig.clf()
ax = fig.add_subplot(111)

plt.plot(R.index, R, color='orange')
