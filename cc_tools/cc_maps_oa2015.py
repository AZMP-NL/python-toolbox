...
df = pd.read_csv('/home/cyrf0006/github/AZMP-NL/datasets/carbonates/AZMP_carbon_data_with2020.csv', delimiter=',')
...
#montage AZMP_OA_2014_fall_Omega_Aragonite_\(unitless\)_bottom.png AZMP_OA_2015_fall_Omega_Aragonite_\(unitless\)_bottom.png AZMP_OA_2016_fall_Omega_Aragonite_\(unitless\)_bottom.png AZMP_OA_2017_fall_Omega_Aragonite_\(unitless\)_bottom.png AZMP_OA_2018_fall_Omega_Aragonite_\(unitless\)_bottom.png AZMP_OA_2019_fall_Omega_Aragonite_\(unitless\)_bottom.png -tile 2x3 -geometry +1+1  -background white OA15_omega_fall_bottom.png

#montage AZMP_OA_2014_fall_Omega_Aragonite_\(unitless\)_surface.png AZMP_OA_2015_fall_Omega_Aragonite_\(unitless\)_surface.png AZMP_OA_2016_fall_Omega_Aragonite_\(unitless\)_surface.png AZMP_OA_2017_fall_Omega_Aragonite_\(unitless\)_surface.png AZMP_OA_2018_fall_Omega_Aragonite_\(unitless\)_surface.png AZMP_OA_2019_fall_Omega_Aragonite_\(unitless\)_surface.png -tile 2x3 -geometry +1+1  -background white OA15_omega_fall_surface.png
