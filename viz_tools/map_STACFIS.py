...
plt.text(x, y, ' HLX-2', horizontalalignment='left', verticalalignment='bottom', fontsize=10, color='r', fontweight='bold', zorder=100)
x, y = m(-66.85, 44.93)
m.scatter(x,y,100,marker='*',color='r', zorder=100)
plt.text(x, y, ' Prince 5', horizontalalignment='left', verticalalignment='bottom', fontsize=10, color='r', fontweight='bold', zorder=100)
# Add other stations
x, y = m(-53.37, 63.88)
m.scatter(x,y,100,marker='*',color='r', zorder=100)
...
plt.text(x, y, ' Misaine', horizontalalignment='left', verticalalignment='bottom', fontsize=10, color='m', fontweight='bold', zorder=100)
x, y = m(-63, 44)
